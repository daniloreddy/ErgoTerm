...
class ErgoTUI(App):
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        if event.button.id == "load_config_btn":
            ...
            arg1 = self.query_one("#input_arg_1", Input).value
            self.call_api_method(log, "get_account_details", [arg1], "Account Details")
    ...
    def load_config(self, log: Log) -> None:
        ...
        try:
            ...
            log.write(
                f"[green]Client configured successfully for URL: {api_url}[/green]"
            )
    ...
    def call_api_method(
        self, log: Log, method_name: str, args: list, display_name: str
    ) -> None:
